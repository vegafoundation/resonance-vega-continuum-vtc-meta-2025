...
\title{VEGA Continuum VTC Meta: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет VEGA Continuum VTC Meta как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
